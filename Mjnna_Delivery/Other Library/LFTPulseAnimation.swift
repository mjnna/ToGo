...
//    var fromValueForAlpha:      Float = 0.60
//    var keyTimeForHalfOpacity:  Float = 0.4
...
//        self.opacity = 0.0
//        self.backgroundColor = UIColor().HexToColor(hexString: GlobalData.BUTTON_COLOR).cgColor
//        self.radius = radius;
...
//        opacityAnimation.values = [self.fromValueForAlpha, 0.9, 0]
